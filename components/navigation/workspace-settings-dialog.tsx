...
import { Settings, Users, ExternalLink, Trash2 } from 'lucide-react';
...
export function WorkspaceSettingsDialog({ workspace, canDelete = false }: WorkspaceSettingsDialogProps) {
